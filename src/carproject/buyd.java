 ...
 * @author USER
 */
public class buyd extends javax.swing.JFrame {

    /**
     * Creates new form buyd
     */
    public buyd() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("To cantact owner ");

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(204, 0, 0));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel15.setText("Extra Specification :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a.setVisible(true);
       String s=jLabel16.getText();
       String no=jLabel12.getText();
       a.jLabel3.setText(s);
       a.jLabel5.setText(no);
       try{
        
         
Connection con =DriverManager.getConnection("jdbc:derby://localhost:1527/carproject","root","Nasusa9866@");
             
String sql="select*from SIGNIN where USERNAME='"+s+"' ";
          Statement st=  con.createStatement();
          st.executeQuery(sql);
          ResultSet rs=st.executeQuery(sql);
          while(rs.next()){
              String add=rs.getString("ADDRESS");
              a.jRadioButton1.setText(add);
          }
...
JOptionPane.showMessageDialog(null,e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buyd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
